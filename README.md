...
```
## **Output:**
![pcm op](https://github.com/user-attachments/assets/89add973-70d3-4ae3-812d-16fc4db0789e)

## **Result:**
Pulse Code Modulation for a given signal using python are verified
